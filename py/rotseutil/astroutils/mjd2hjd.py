...
if __name__ == "__main__":
    ...
    parser.add_argument('--truncateHjd', '-t', default = False, help = 'Truncate HJD to HJD-2400000')
    parser.add_argument('--verbose', '-v', default = False, help = 'Print HJD light curve to terminal')
    args = parser.parse_args()
    file = args.file
    rightAscension = args.rightAscension
    declination = args.declination
    epoch = args.epoch
    truncateHjd = evalBoolArg(args.truncateHjd, False)
